...
export const metadata: Metadata = { title: { default: "LEEMING — Personal Digital Archive", template: "%s — LEEMING" }, description: "A maintained personal digital archive for collecting, organizing, retrieving and maintaining useful resources." };
